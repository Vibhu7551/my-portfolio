    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-pink-200 via-purple-200 to-blue-200 p-10">
      <div className="max-w-4xl mx-auto p-8 rounded-lg">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <img
            src={process.env.PUBLIC_URL + "/tamilocr-screenshot1.png"}
            alt="Palm Leaf Manuscript Processing Screenshot 1"
            className="rounded-lg shadow"
          />
          <img
            src={process.env.PUBLIC_URL + "/tamilocr-screenshot2.png"}
        ...
        <ul className="list-disc list-inside text-gray-700 mb-8">
          ...
          <li>
            <strong>Segmentation process completed ✅</strong>
          </li>
        ...
        <div className="flex space-x-4 mb-8">
          <span className="px-4 py-2 bg-white rounded-lg shadow-lg">Python</span>
          <span className="px-4 py-2 bg-white rounded-lg shadow-lg">OpenCV</span>
          <span className="px-4 py-2 bg-white rounded-lg shadow-lg">Deep Learning</span>
        </div>
