...
const Home = () => {
  return (
    <div className="w-full">
      ...
      <section
        id="hero"
        className="pt-24 min-h-[90vh] flex flex-col items-center justify-center text-center 
      ...
      >
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="#projects"
              className="px-6 sm:px-8 py-3 sm:py-4 bg-indigo-600 text-white rounded-lg font-semibold 
            ...
            <Link
              to="/about"
              className="px-6 sm:px-8 py-3 sm:py-4 border border-indigo-600 text-indigo-600 rounded-lg 
            ...
            <Link
              to="/resume"
              className="px-6 sm:px-8 py-3 sm:py-4 border border-gray-400 text-gray-700 rounded-lg 
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          <Link
            ...
            className="block bg-gray-50 p-6 rounded-lg shadow hover:shadow-xl hover:scale-105 transition"
          >
          ...
          >
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              A fun Flappy Bird clone created using Python and Pygame mechanics.
            </p>
          </Link>
        </div>
      </section>
